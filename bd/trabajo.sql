...
INSERT INTO `pagos` (`idpago`, `idtransaccion`, `usuario`, `fecha`, `cuota`) VALUES
...
CREATE TABLE `pedidos` (
  ...
  `adelanto` decimal(16,2) NOT NULL,
...
INSERT INTO `pedidos` (`idpermiso`, `idcliente`, `usuario`, `ftransaccion`, `monto`, `adelanto`, `saldo`, `formapago`, `fpago`, `plazo`, `fplazo`, `estado`) VALUES
...
(3, 'limbert', 'Centro 2', '8333333', 'admin', '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', '', 1),
(4, 'limbert', 'Centro', '222222', 'limbert', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', '', 1);
...
ALTER TABLE `transaccion`
  ...
  ADD UNIQUE KEY `idgasto_UNIQUE` (`ido`),
...
ALTER TABLE `pagos`
  ...
  ADD KEY `fkpedidos_idx` (`idpedido`);
...
--
ALTER TABLE `transaccion`
  ADD CONSTRAINT `fktransaccionusuarios` FOREIGN KEY (`idusuario`) REFERENCES `usuarios` (`idusuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `pagos`
--
ALTER TABLE `pagos`
  ADD CONSTRAINT `fkpedidos_idx` FOREIGN KEY (`idprestamo`) REFERENCES `pedidos` (`idpedido`) ON DELETE NO ACTION ON UPDATE NO ACTION;
