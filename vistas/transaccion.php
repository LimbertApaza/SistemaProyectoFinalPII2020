        ...
        <div class="col-lg-12">
            <div class="main-box clearfix">
                <header class="main-box-header clearfix">
                    <h2 class="box-title">Transaccion/Trabajo <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Nuevo</button></h2>
                </header>
                    ...
                    <form name="formulario" id="formulario" method="POST">
                        <div class="row">
                          ...
                          <div class="row">
                            ...
                            <input type="text" name="concepto" id="concepto" class="form-control" placeholder="Ingresa el tipo de trabajo" maxlength="50" required>
                        </div>
                          </div>
                        <div class="row">
...
require 'footer.php';
?>
        <script type="text/javascript" src="scripts/transaccion.js"></script>
<?php 
}
ob_end_flush();
?>